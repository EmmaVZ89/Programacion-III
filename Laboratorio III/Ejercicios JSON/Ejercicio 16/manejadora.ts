namespace Entidades {
  ...
  export function CargarRemeras3(): void {
  ...
  export function FiltrarRemerasPorCampo(): void {
    let caracteristica = (<HTMLInputElement>(document.getElementById("txtCaracteristica"))).value;
